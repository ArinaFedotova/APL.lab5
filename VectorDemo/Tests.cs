...
namespace VectorDemo
{
    public class Tests
    {
        ...
        private static double[] arr = new double[] { 10, -10};
        private IMathVector mv1 = new MathVector(arr);
        public void ConstructorTest()
        {
            Console.WriteLine("1. Constructor test: ");
            Console.WriteLine($"\tVector1 was created: {mVector1}");
            Console.WriteLine($"\tVector2 was created: {mVector2}");
        }
